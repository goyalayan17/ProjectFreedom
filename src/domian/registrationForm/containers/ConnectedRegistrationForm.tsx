...
import {
	registrationDeleteAction,
	registrationEditAction,
	registrationFormAction,
	registrationFormDetailsRequestAction,
...
const mapDispatchToProps = (dispatch: Dispatch): IDispatchProps => ({
	onChange: (name: string, value: string | number) => dispatch(registrationFormAction({ name, value })),

	onSubmit: (registrationForm: IRegistrationForm) => dispatch(registrationPostDetailsAction({ registrationForm })),

	onEdit: (index: number | undefined) => dispatch(registrationEditAction({ index })),
	...
	onDelete: (index: number | undefined) => dispatch(registrationDeleteAction({ index })),

	getRegistrationDetails: () => dispatch(registrationFormDetailsRequestAction()),
	onCancle: () => dispatch(registrationFormEmpty()),
});
