...
export interface IAddRegistrationUpdateAction extends BaseAction<{ index : number | undefined , registrationForm:IRegistrationForm}> { }

export const registrationUpdateAction: (payload: {
    index : number | undefined , registrationForm:IRegistrationForm
